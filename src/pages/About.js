        ...
        <div className="top-section">
          <div className="left">
            ...
            <h2 className="about__heading">
              A frontend developer & blockchain consultant
            </h2>
            <div className="about__info">
              <PText>
                Hello & welcome to my portoflio, please note that portfolio will
                be updated, Allow me to show you my passion and potential
                towards my work and efficiency I’m a Front-End developer with a
                5 years of experience in frontend REACT, HTML, CSS, Bootstrap,
                jQuery, responsive design. I share my time in agency and
                freelance. <br />
              </PText>
            </div>
